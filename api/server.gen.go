...
func (siw *ServerInterfaceWrapper) DeleteUsersDeleteId(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.DeleteUsersDeleteId(w, r, id)
	}))
...
// GetUsersGetAllUsers operation middleware
func (siw *ServerInterfaceWrapper) GetUsersGetAllUsers(w http.ResponseWriter, r *http.Request) {

	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetUsersGetAllUsers(w, r)
	}))
...
// PutUsersUpdateId operation middleware
func (siw *ServerInterfaceWrapper) PutUsersUpdateId(w http.ResponseWriter, r *http.Request) {
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/users/GetAllUsers", wrapper.GetUsersGetAllUsers)
	})
	r.Group(func(r chi.Router) {
